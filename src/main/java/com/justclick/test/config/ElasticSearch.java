package com.justclick.test.config;
 ...
 */
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.justclick.test.repository")
@ComponentScan(basePackages = { "com.justclick.test.service" })
